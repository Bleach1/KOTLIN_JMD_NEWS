...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    ItemHeaderDecoration(Context context, List<ContentBean> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(List<ContentBean> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    private void drawHeader(RecyclerView parent, int pos, Canvas canvas) {
        View topTitleView = mInflater.inflate(R.layout.sticky_header, parent, false);
