...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public final static String CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.national.security.community.CONNECTIVITY_CHANGE";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Objects.requireNonNull(intent.getAction()).equalsIgnoreCase(ANDROID_NET_CHANGE_ACTION) || intent.getAction().equalsIgnoreCase(CUSTOM_ANDROID_NET_CHANGE_ACTION)) {
